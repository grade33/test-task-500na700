...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "burgerMenuSubparagraph": () => (/* binding */ burgerMenuSubparagraph),
/* harmony export */   "initAccordion": () => (/* binding */ initAccordion),
/* harmony export */   "initSwiperNews": () => (/* binding */ initSwiperNews),
/* harmony export */   "initSwiperPresentation": () => (/* binding */ initSwiperPresentation),
/* harmony export */   "navSubparagraph": () => (/* binding */ navSubparagraph),
/* harmony export */   "openCloseBurgerMenu": () => (/* binding */ openCloseBurgerMenu),
/* harmony export */   "phoneMask": () => (/* binding */ phoneMask),
/* harmony export */   "setTopPaddingMain": () => (/* binding */ setTopPaddingMain)
/* harmony export */ });
...
function initSwiperPresentation() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".presentation__slider", {
...
function initAccordion() {
  var accCol = document.querySelectorAll(".acc");
  accCol.forEach(function (acc) {
    var accBtn = acc.querySelector(".acc__btn");
    var accBtnPaddingTop = +getComputedStyle(accBtn).paddingTop.slice(0, -2);
    var accPanel = acc.querySelector(".acc__panel");
    accBtn.addEventListener("click", function () {
      accCol.forEach(function (otherAcc) {
        if (acc === otherAcc || !otherAcc.classList.contains("acc_active")) return;
        var otherAccPanel = otherAcc.querySelector(".acc__panel");
      ...
      accPanel.style.maxHeight = accPanel.scrollHeight + accBtnPaddingTop + "px";
    });
  });
}
function navSubparagraph() {
  var navBtnsCol = document.querySelectorAll(".nav__btn");
  var header = document.querySelector(".header");
  var headerPaddingBottom = +getComputedStyle(header).paddingBottom.slice(0, -2);
  var waitingTranition = false;
  navBtnsCol.forEach(function (navBtn) {
    var navMore = navBtn.nextElementSibling;
    ...
    navBtn.addEventListener("click", function () {
      ...
      navBtnsCol.forEach(function (otherNavBtn) {
        if (otherNavBtn === navBtn) return;
        if (!otherNavBtn.classList.contains("nav__btn_active")) return;
        var otherNavMore = otherNavBtn.nextElementSibling;
      ...
      var openMenu = function openMenu() {
        header.style.paddingBottom = navMore.scrollHeight + headerPaddingBottom + "px";
  ...
  document.addEventListener("click", function (e) {
    var activeNavBtn = document.querySelector(".nav__btn_active");
    if (e.target.closest(".nav__btn") || !activeNavBtn) return;
    var activeNavMore = activeNavBtn.nextElementSibling;
    header.style.paddingBottom = headerPaddingBottom + "px";
...
function burgerMenuSubparagraph() {
  var navBtnsCol = document.querySelectorAll(".burger-menu__btn");
  var waitingTranition = false;
  navBtnsCol.forEach(function (navBtn) {
    var navMore = navBtn.nextElementSibling;
    navBtn.addEventListener("click", function () {
  ...
  document.addEventListener("click", function (e) {
    var activeNavBtn = document.querySelector(".burger-menu__btn_active");
...
function phoneMask() {
  var phoneMask = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelector('[data-mask="phone"]'), {
    mask: '+{7}(000)000-00-00'
  });
}
function setTopPaddingMain() {
...
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.navSubparagraph)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.burgerMenuSubparagraph)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.openCloseBurgerMenu)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.initAccordion)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.initSwiperPresentation)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.initSwiperNews)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.phoneMask)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.setTopPaddingMain)();
